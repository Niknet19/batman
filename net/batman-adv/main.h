...
#define BATADV_AIRTIME_MAX_VALUE        0xFFFFFFFF  /* максимальная стоимость (худший линк) */
#define BATADV_AIRTIME_OVERHEAD         300         /* O в микросекундах: DIFS + backoff + preamble + SIFS + ACK */
#define BATADV_AIRTIME_TEST_FRAME_SIZE  8192        /* B_t в битах (1024 байта по 802.11s) */
#define BATADV_AIRTIME_EWMA_WEIGHT      4           /* вес для EWMA-сглаживания e_pt (1/4) */
#define BATADV_AIRTIME_HALF_DUPLEX_PENALTY 2        /* множитель airtime для полудуплекса */
