...
struct batadv_hardif_neigh_node_bat_v {
    ...
    u32 e_pt_smoothed;       // сглаженная частота ошибок кадра (в тысячных долях, 0-1000)
...
struct batadv_neigh_ifinfo_bat_v {
	 ...
	 *  neigh
	 */
	u32 airtime_cost; // airtime-стоимость пути через этого соседа на этом интерфейсе (мкс)
