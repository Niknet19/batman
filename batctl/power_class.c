...
static struct simple_boolean_data power_class;
...
static int set_attrs_power_class(struct nl_msg *msg, void *arg) {
  ...
  nla_put_u8(msg, BATADV_ATTR_POWER_CLASS, data->val);
...
COMMAND_NAMED(SUBCOMMAND_MIF, power_class, "pc", handle_sys_setting,
              ...
              "[value]           \tdisplay or modify power class (1=mains, "
              "2=battery, 3=energy harvesting)");